    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
							...
							<div class="text-center item">
								<div class="col-md-8 col-md-offset-2 col-sm-12">
									<div class="big-tagline text-center">
										<h2><strong> Barber Shops</strong><br>
										In Your Area</h2>
										<p class="lead">Schedule Your Appointment Today!</p>
										<a href="#" class="btn btn-light btn-radius btn-brd grd1 effect-1 butn">SCHEDULE NOW</a>
									</div>
								</div>
							</div>
							<div class="text-center item">
            ...
            <section class="section nopad cac text-center">
                <a href="#"><h3>Interested in scheduling an appointment with one of our barbers? Schedule an appointment using the form below!</h3></a>
            </section>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center">
                            <div class="message-box">
                                <h4>About</h4>
                                <h2>Welcome to Fresh Cuts Appointments</h2>
                                <p class="lead">Where you can schedule your next haircut with confidence.</p>

                                <p>We work with top notch barber shops so you can schedule your appointment worry free.
                                    With locations near you, click below to learn more. </p>
