            ...
            <div id="appointment" class="section wb">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="contact_form">
                                <div id="message"></div>
                                <form id="contactform" class="row" method="post" action="SetApp.do" name="contactform">
                                    <fieldset class="row-fluid">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="pzipcode" class="form-control"
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <textarea class="form-control" name="comments" id="comments" rows="6"
                                                placeholder="Any details you would like for us to have in mind?"></textarea>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                            <button type="submit" 
                                                class="btn btn-light btn-radius btn-brd grd1 btn-block subt" 
                                                value="add">Schedule Appointment</button>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
                    ...
                    <div>
                        ...
                        <ul class="unstyled">
                            <li ng-repeat="app in appointment">
                                {{app.first_name}} {{app.last_name}}, {{app.email}}, {{app.phone}}, {{app.time}}
                            </li>
                        </ul>

                        <br>
                        <form ng-submit="editAppointment()">
                            <input class="btn-primary" type="submit" value="Edit Appointment">
                        </form>
                    </div>
